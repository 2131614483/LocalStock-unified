...
class PromptSettings(BaseModel):
    ...
    #: Include the instrument's display name (e.g. 中芯国际) next to its code in
    #: the prompt and in offline-pack headers.  Purely descriptive.
    include_symbol_name: bool = True
...
class GeneralSettings(BaseModel):
    ...
    #: Toolbar 「品种」 selector — stock | index | forex | futures | crypto.
    last_instrument_class: str = "stock"
