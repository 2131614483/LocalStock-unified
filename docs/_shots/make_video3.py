...
W, H = 1920, 1080
clips = [
    ('desktop-watchlist.png', 6.10),   # 1 自选股开篇
    ('desktop-dayk.png', 6.68),       # 2 三大组件
    ('desktop-market.png', 4.51),     # 3 沪深A股5973只
    ('desktop-weekk.png', 11.51),     # 4 K线多周期
    ('desktop-drawing.png', 2.91),    # 5 画线
    ('desktop-minute.png', 4.60),     # 6 分时+新闻
    ('desktop-backtest.png', 3.40),   # 7 回测
    ('jq-home.png', 3.52),            # 8 聚宽回测
    ('desktop-alert.png', 2.70),      # 9 预警
    ('desktop-pa.png', 5.55),        # 10 价格行为AI
    ('desktop-ai-page.png', 7.28),    # 11 AI优先
    ('desktop-ai-config.png', 7.18),  # 12 知识库/未来
    ('desktop-settings.png', 6.26),  # 13 多模型后端
    ('desktop-watchlist.png', 11.94), # 14 多源多窗口
    ('desktop-watchlist.png', 17.86), # 15 收尾
]
